      ...
      <div class="row">
          <div class="box float mx-auto mt-5">
              <div class="card text-center">
                  ...
                  <form action="<?= base_url('user/edit_medcheck/') . $pasien['id']; ?>" method="post">
                      <div class="card-body">
                          <div class="col-md-4">
                              ...
                              <div class="col-sm-6">
                                  <div class="card">
                                      <div class="card-body">
                                          ...
                                          <p class="card-text"><input class="form-control" type="date" value="<?= $pasien['tgl_lahir'] ?>" name="tgl_lahir"></p>
