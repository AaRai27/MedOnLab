  						...
  						<div class="col-sm-6">
  							<div class="card">
  								<div class="card-body">
  									...
  									<p class="card-text"><input class="form-control" type="text" value="<?= date("d F Y", strtotime($pasien['tgl_lahir'])) ?>" disabled></p>
  						...
  						<div class="col-sm-6">
  							<div class="card">
  								<div class="card-body">
  									...
  									<p class="card-text"><input class="form-control text-capitalize" type="text" value="<?= $pasien['layanan'] ?>" disabled></p>
  									<!-- <a href="#" class="btn btn-primary">Update</a> -->
  									<!-- Untuk UPDATE -->
  								</div>
  							</div>
  						...
  						<div class="col-sm-6">
  							<div class="card">
  								<div class="card-body">
  									...
  									<p class="card-text"><input class="form-control" type="text" value="<?= $pasien['cabang'] ?>" disabled></p>
  									<!-- <a href="#" class="btn btn-primary">Update</a> -->
  									<!-- Untuk UPDATE -->
  								</div>
  							</div>
  						...
  						<div class="col-sm-6">
  							<div class="card">
  								<div class="card-body">
  									...
  									<p class="card-text"><input class="form-control" type="text" value="<?= $pasien['tgl_periksa'] ?>" disabled></p>
  									<!-- <a href="#" class="btn btn-primary">Update</a> -->
  									<!-- Untuk UPDATE -->
  								</div>
  							</div>
  						...
  						<div class="col-sm-6">
  							<div class="card">
  								<div class="card-body">
  									...
  									<p class="card-text"><input class="form-control" type="text" value="<?= $pasien['alamat'] ?>" disabled></p>
  									<!-- <a href="#" class="btn btn-primary">Update</a> -->
  									<!-- Untuk UPDATE -->
  								</div>
  							</div>
  						...
  						<div class="col-sm-6">
  							<div class="card">
  								<div class="card-body">
  									...
  									<p class="card-text"><input class="form-control" type="text" value="<?= $pasien['nomor_hp'] ?>" disabled></p>
  									<!-- <a href="#" class="btn btn-primary">Update</a> -->
  									<!-- Untuk UPDATE -->
  								</div>
  							</div>
