    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #1eb2a6;">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item text-white nav-link" href="">Pendaftaran</a>
                <a class="nav-item text-white nav-link" href="">Info Kesehatan</a>
            </div>
        </div>
        <form class="form-inline">
            <!-- <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search"> -->
            <a href="" class="btn btn-outline-primary my-2 my-sm-0 mx-2 text-white" type="button">Login</a>
            <a href="" class="btn btn-outline-primary my-2 my-sm-0 text-white" type="button">Register</a>
        </form>
    </nav>
    <!-- ----------------------------------- Navbar ----------------------------------- -->